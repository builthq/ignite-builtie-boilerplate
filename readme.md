# Ignite Built.ie Boilerplate

## The latest and greatest boilerplate for Infinite Red opinions

This is the Ignite boilerplate that [Built.ie](http://built.ie) uses to create awesome React Native apps.
...
[Built.ie](http://built.ie) offers premium support and general mobile app design/development services. [Contact us](https://built.ie/contact/new) to get in touch.
