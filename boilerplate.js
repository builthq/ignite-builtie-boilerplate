...
async function install (context) {
  ...
  try {
    ...
    const boilerplate = parameters.options.b || parameters.options.boilerplate || 'ignite-builtie-boilerplate'
  ...
  const successMessage = `
    ...
    ${gray('Read the walkthrough at https://github.com/builthq/ignite-builtie-boilerplate/blob/master/readme.md#boilerplate-walkthrough')}
